...
import { CardModel, Image, ContentModel } from "w-brew";
...
export class LinktestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const contentOne = new ContentModel(
      undefined,
      "Card title",
    ...
    const contentTwo = new ContentModel(
      undefined,
      "Card title",
      "This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.",
      true,
    ...
    const contentFullOne = new ContentModel(
      undefined,
      "Card title",
      "This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.",
      false,
    ...
    const contentFullTwo = new ContentModel(
      undefined,
      "Card title",
      "This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.",
      true,
