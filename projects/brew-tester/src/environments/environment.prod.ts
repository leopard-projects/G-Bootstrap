export const environment = {
  ...
  api: {
    promotion: '../../w-beta/assets/mock-prod-api/promotion.json',
    carousel: '../../w-beta/assets/mock-prod-api/carousel.json',
    widecontainerone: '../../w-beta/assets/mock-api/wide-container-one.json',
